...
from .views import CreateUserView, LoginView, LogoutView, UserUpdateView, GameHistoryListView, CreateFriendRequestView, AcceptFriendRequestView, ListFriendsView, RejectCancelFriendRequestView, RemoveFriendView, CurrentUserProfileView
