...
from .views import CreateUserView, LoginView, AuthView, LogoutView, UserUpdateView, GameHistoryListView, CreateFriendRequestView, AcceptFriendRequestView, ListFriendsView, RejectCancelFriendRequestView, RemoveFriendView, CurrentUserProfileView, AvatarUploadView
