...
from .views import CreateUserView, LoginView, AuthView, CallBackView, CallBackCodeView, LogoutView, UserUpdateView, GameHistoryListView, CreateFriendRequestView, AcceptFriendRequestView, ListFriendsView, RejectCancelFriendRequestView, RemoveFriendView, CurrentUserProfileView, AvatarUploadView
