...
class MatchModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.match = Match.objects.create(
            player1=cls.player1, player2=cls.player2, start_time=timezone.now()
        )
...
class MatchViewTest(TestCase):
    def setUp(self):
        ...
        self.match = Match.objects.create(
            player1=self.player1, player2=self.player2, start_time=timezone.now()
        )
...
class MatchListViewTest(APITestCase):
    def setUp(self):
        ...
        Match.objects.create(
            player1=self.user1, player2=self.user2, start_time=timezone.now()
        )
