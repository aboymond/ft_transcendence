...
const PixiManager: React.FC = () => {
	const [currentScene, setCurrentScene] = useState<React.ReactElement | null>(null);

	const loadScene = (scene: React.ReactElement) => {
		setCurrentScene(scene);
	};

	return <Stage>{currentScene}</Stage>;
};
