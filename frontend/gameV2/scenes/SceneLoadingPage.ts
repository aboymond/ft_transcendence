...
const tipsTab = [
	...
	new PIXI.Text("TIP: If the game seems easy,\n\t\t\t\t\t\t\t\t\t\t\tyou're probably doing something wrong.\n\t\t\t\t\t\t\t\t\t\t\tOr not."),
